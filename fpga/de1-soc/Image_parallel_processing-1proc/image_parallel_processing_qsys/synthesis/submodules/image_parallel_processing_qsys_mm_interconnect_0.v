...
module image_parallel_processing_qsys_mm_interconnect_0 (
	...
	wire         mutex_0_s1_agent_rp_valid;                                                     // mutex_0_s1_agent:rp_valid -> router_001:sink_valid
	wire  [96:0] mutex_0_s1_agent_rp_data;                                                      // mutex_0_s1_agent:rp_data -> router_001:sink_data
	wire         mutex_0_s1_agent_rp_ready;                                                     // router_001:sink_ready -> mutex_0_s1_agent:rp_ready
	wire         mutex_0_s1_agent_rp_startofpacket;                                             // mutex_0_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         mutex_0_s1_agent_rp_endofpacket;                                               // mutex_0_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [78:0] sdram_controller_s1_agent_rp_data;                                             // sdram_controller_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [78:0] router_002_src_data;                                                           // router_002:src_data -> sdram_controller_s1_rsp_width_adapter:in_data
	wire         router_002_src_ready;                                                          // sdram_controller_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire   [1:0] router_002_src_channel;                                                        // router_002:src_channel -> sdram_controller_s1_rsp_width_adapter:in_channel
	...
	image_parallel_processing_qsys_mm_interconnect_0_router_001 router_001 (
