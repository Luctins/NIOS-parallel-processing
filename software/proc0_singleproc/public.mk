...
SOPCINFO_FILE := /home/luctins/repo/NIOS-parallel-processing/Image_parallel_processing-1proc/image_parallel_processing_qsys.sopcinfo
...
# CPU Name 
# setting CPU_NAME is proc_0_0_proc_0
CPU_NAME = proc_0_0_proc_0
...
# Design Name 
# setting SOPC_NAME is image_parallel_processing_qsys
SOPC_NAME := image_parallel_processing_qsys
...
# setting hal.stderr is proc_0_0_jtag_uart_0
ELF_PATCH_FLAG  += --stderr_dev proc_0_0_jtag_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is proc_0_0_jtag_uart_0
ELF_PATCH_FLAG  += --stdin_dev proc_0_0_jtag_uart_0
...
# setting hal.stdout is proc_0_0_jtag_uart_0
ELF_PATCH_FLAG  += --stdout_dev proc_0_0_jtag_uart_0
