...
# Memory: proc_0_0_onchip_memory2_0
MEM_0 := image_parallel_processing_qsys_proc_0_0_onchip_memory2_0
$(MEM_0)_NAME := proc_0_0_onchip_memory2_0
...
$(MEM_0)_HIERARCHICAL_PATH := proc_0_0.onchip_memory2_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: proc_0_0_onchip_memory2_0
proc_0_0_onchip_memory2_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
